...
const index = require("./index-DP0X-32m.js");
...
const OperationalBadges = ({ pendingApprovals = 0, pendingVerifications = 0 }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(BadgeRow, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#f59e0b", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(index.Expert, { style: { width: "13px", height: "13px", color: "#d28809ff" } }),
...
exports.default = App;
//# sourceMappingURL=App-7O7axyaA.js.map
