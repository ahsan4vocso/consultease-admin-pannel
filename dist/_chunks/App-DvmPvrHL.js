...
const index = require("./index-CM0XGpMX.js");
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { paddingTop: 2, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          NavButton,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(IconWrapper$5, { children: /* @__PURE__ */ jsxRuntime.jsx(index.SettingsIcon, { style: { width: "1.8rem", height: "1.8rem" } }) }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "beta", children: "Settings" })
            ]
          }
        )
      ] })
...
const SettingsHeaderContainer = styled__default.default(Header$5)`
  background: ${({ theme }) => theme.colors.neutral0};
  border-bottom: 1px solid ${({ theme }) => theme.colors.neutral150};
  padding: 16px 32px;
`;
const SettingsHeader = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(SettingsHeaderContainer, { children: /* @__PURE__ */ jsxRuntime.jsxs(HeaderLeft$1, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(IconBox$3, { children: /* @__PURE__ */ jsxRuntime.jsx(index.SettingsIcon, { style: { width: "32px", height: "32px", color: "#6366f1" } }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(TitleBox, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(Title$6, { children: "Platform Settings" }),
      /* @__PURE__ */ jsxRuntime.jsx(Subtitle, { children: "Optimize platform performance, reconcile financial records, and perform expert lifecycle maintenance tasks." })
    ] })
  ] }) });
};
const SettingsContainer = styled__default.default.div`
  padding: 16px 32px 32px 32px;
  width: 100%;
`;
const ActionGrid = styled__default.default.div`
  display: grid;
  ...
  width: 100%;
`;
const ActionCard = styled__default.default(designSystem.Box)`
  padding: 24px;
  background: ${({ theme }) => theme.colors.neutral0};
  border: 1px solid ${({ theme }) => theme.colors.neutral150};
  border-radius: 16px;
...
const SettingsPage = () => {
  ...
  const handleDbAction = async (action, endpoint) => {
    if (!endpoint) {
      reactToastify.toast.info(`Action "${action}" is coming soon.`);
      return;
    }
    ...
    try {
      ...
      reactToastify.toast.success(`${data.message} ${cancelledCount} transactions updated.`);
    } catch (error) {
      console.error(`Error executing ${action}:`, error);
      reactToastify.toast.error(error?.response?.data?.error?.message || `Failed to execute ${action}`);
    } finally {
      setLoadingAction(null);
    }
  };
  return /* @__PURE__ */ jsxRuntime.jsx(PluginLayout, { children: /* @__PURE__ */ jsxRuntime.jsxs(DashboardContainer$1, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(SettingsHeader, {}),
    /* @__PURE__ */ jsxRuntime.jsx(Main, { children: /* @__PURE__ */ jsxRuntime.jsx(SettingsContainer, { children: /* @__PURE__ */ jsxRuntime.jsxs(ActionGrid, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", fontWeight: "bold", children: "Cancel Stale Transactions" }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: "Cancel pending PayU topups and transactions older than 30 minutes to prevent data bloat." }) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Button,
          {
            ...
            children: "Cancel Pending"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", fontWeight: "bold", children: "Generate Monthly Invoices" }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: "Manually trigger the generation of monthly statements and invoices for the current period." }) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Button,
          {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", fontWeight: "bold", children: "End Stuck Calls" }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: "Detect and terminate calls stuck in 'ringing' or 'ongoing' states for an unusual amount of time." }) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Button,
          {
            ...
            children: "Terminate Stale"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", fontWeight: "bold", children: "Refresh Expert Rankings" }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: 'Recalculate rank factors, review averages, and update "Top 10%" milestones for all experts.' }) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Button,
          {
            ...
            children: "Recalculate Ranks"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", fontWeight: "bold", children: "Purge Logs & OTPs" }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: "Clear expired session logs, OTP entries, and temporary authentication data from the database." }) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Button,
          {
            ...
            children: "Clean Auth Data"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", fontWeight: "bold", children: "Clean Call Documents" }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: "Permanently remove expired recordings and temporary call documents older than the retention policy." }) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Button,
          {
