...
const OperationalBadges = ({
  ...
  return /* @__PURE__ */ jsxs(BadgeRow, { children: [
    ...
    /* @__PURE__ */ jsxs(MiniBadge, { color: "#f59e0b", children: [
      ...
      /* @__PURE__ */ jsxs(Count, { children: [
        pendingApprovals,
        todayApprovals > 0 && /* @__PURE__ */ jsxs("span", { style: { fontSize: "10px", marginLeft: "4px", opacity: 0.8 }, children: [
          "(+",
          todayApprovals,
          " Today)"
        ] })
    ...
    /* @__PURE__ */ jsxs(MiniBadge, { color: "#3b82f6", children: [
      ...
      /* @__PURE__ */ jsxs(Count, { children: [
        ...
        todayVerifications > 0 && /* @__PURE__ */ jsxs("span", { style: { fontSize: "10px", marginLeft: "4px", opacity: 0.8 }, children: [
          "(+",
          todayVerifications,
          " Today)"
        ] })
...
//# sourceMappingURL=App-CCv4LRPM.mjs.map
