...
const ActionStrip = ({ pendingApprovals = 0, pendingVerifications = 0 }) => {
  ...
  return /* @__PURE__ */ jsxs(StripContainer, { style: { background: "linear-gradient(90deg, rgba(255,255,255,0.8) 0%, rgba(245,158,11,0.05) 100%)" }, children: [
    /* @__PURE__ */ jsx(Flex, { alignItems: "center", gap: 2, style: { marginRight: "12px" }, children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", textColor: "primary600", fontWeight: "bold", children: "Attention Required:" }) }),
    /* @__PURE__ */ jsxs(ActionItem, { children: [
      /* @__PURE__ */ jsx(PulseDot, { color: "#f59e0b" }),
      /* @__PURE__ */ jsx(Label, { children: "Expert Approvals" }),
      /* @__PURE__ */ jsx(Badge, { color: "#f59e0b", children: displayApprovals })
    ] }),
    /* @__PURE__ */ jsxs(ActionItem, { children: [
      /* @__PURE__ */ jsx(PulseDot, { color: "#3b82f6" }),
      /* @__PURE__ */ jsx(Label, { children: "Expert Verifications" }),
      /* @__PURE__ */ jsx(Badge, { color: "#3b82f6", children: displayVerifications })
    ] })
  ] });
};
...
//# sourceMappingURL=App-DyZ951Kq.mjs.map
