...
import { Flex, Box, Typography, Divider, SubNav, Button } from "@strapi/design-system";
import { A as AnalyticalDashboardIcon, P as PLUGIN_ID, C as CallAnalyticsIcon, a as ChartIcon, R as ReferralLogo, S as SettingsIcon, V as VoiceCall, b as VideoCall, c as Cross, d as ChevronDown, T as Tick, e as ActiveCall, f as TotalCalls, D as DeclineCall, g as CompletedCall, E as Expert, h as CallTime, i as SearchIcon, j as ReferralIcon, k as ConversionIcon, U as UniqueIcon, W as WalletIcon, l as ActivityIcon, m as TrendingUpIcon, n as UsersIcon, B as BriefcaseIcon, o as UserCheckIcon, p as ExperimentIcon } from "./index-BTMnhLW0.mjs";
      ...
      /* @__PURE__ */ jsxs(Box, { paddingTop: 2, children: [
        ...
        /* @__PURE__ */ jsxs(
          NavButton,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(IconWrapper$5, { children: /* @__PURE__ */ jsx(SettingsIcon, { style: { width: "1.8rem", height: "1.8rem" } }) }),
              /* @__PURE__ */ jsx(Typography, { variant: "beta", children: "Settings" })
            ]
          }
        )
      ] })
...
const OperationalBadges = ({ pendingApprovals = 0, pendingVerifications = 0, filter = "monthly", onFilterChange }) => {
  ...
  return /* @__PURE__ */ jsxs(Box, { display: "flex", alignItems: "center", width: "100%", children: [
    /* @__PURE__ */ jsxs(BadgeRow, { style: { marginBottom: 0, marginTop: 0 }, children: [
      ...
      /* @__PURE__ */ jsxs(MiniBadge, { color: "#f59e0b", onClick: handleApprovalsClick, children: [
      ...
      /* @__PURE__ */ jsxs(MiniBadge, { color: "#3b82f6", onClick: handleVerificationsClick, children: [
...
const SettingsHeaderContainer = styled(Header$5)`
  background: ${({ theme }) => theme.colors.neutral0};
  border-bottom: 1px solid ${({ theme }) => theme.colors.neutral150};
  padding: 16px 32px;
`;
const SettingsHeader = () => {
  return /* @__PURE__ */ jsx(SettingsHeaderContainer, { children: /* @__PURE__ */ jsxs(HeaderLeft$1, { children: [
    /* @__PURE__ */ jsx(IconBox$3, { children: /* @__PURE__ */ jsx(SettingsIcon, { style: { width: "32px", height: "32px", color: "#6366f1" } }) }),
    /* @__PURE__ */ jsxs(TitleBox, { children: [
      /* @__PURE__ */ jsx(Title$6, { children: "Platform Settings" }),
      /* @__PURE__ */ jsx(Subtitle, { children: "Optimize platform performance, reconcile financial records, and perform expert lifecycle maintenance tasks." })
    ] })
  ] }) });
};
...
const SettingsPage = () => {
  ...
  return /* @__PURE__ */ jsx(PluginLayout, { children: /* @__PURE__ */ jsxs(DashboardContainer$1, { children: [
    ...
    /* @__PURE__ */ jsx(Main, { children: /* @__PURE__ */ jsx(SettingsContainer, { children: /* @__PURE__ */ jsxs(ActionGrid, { children: [
      /* @__PURE__ */ jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxs(Box, { children: [
          /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", children: "Cancel Stale Transactions" }),
          /* @__PURE__ */ jsx(Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", children: "Cancel pending PayU topups and transactions older than 30 minutes to prevent data bloat." }) })
        ] }),
        /* @__PURE__ */ jsx(
          Button,
          {
      ...
      /* @__PURE__ */ jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxs(Box, { children: [
          /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", children: "Generate Monthly Invoices" }),
          /* @__PURE__ */ jsx(Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", children: "Manually trigger the generation of monthly statements and invoices for the current period." }) })
        ] }),
        /* @__PURE__ */ jsx(
          Button,
          {
      ...
      /* @__PURE__ */ jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxs(Box, { children: [
          /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", children: "End Stuck Calls" }),
          /* @__PURE__ */ jsx(Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", children: "Detect and terminate calls stuck in 'ringing' or 'ongoing' states for an unusual amount of time." }) })
        ] }),
        /* @__PURE__ */ jsx(
          Button,
          {
      ...
      /* @__PURE__ */ jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxs(Box, { children: [
          /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", children: "Refresh Expert Rankings" }),
          /* @__PURE__ */ jsx(Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", children: 'Recalculate rank factors, review averages, and update "Top 10%" milestones for all experts.' }) })
        ] }),
        /* @__PURE__ */ jsx(
          Button,
          {
      ...
      /* @__PURE__ */ jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxs(Box, { children: [
          /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", children: "Purge Logs & OTPs" }),
          /* @__PURE__ */ jsx(Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", children: "Clear expired session logs, OTP entries, and temporary authentication data from the database." }) })
        ] }),
        /* @__PURE__ */ jsx(
          Button,
          {
      ...
      /* @__PURE__ */ jsxs(ActionCard, { children: [
        /* @__PURE__ */ jsxs(Box, { children: [
          /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", children: "Clean Call Documents" }),
          /* @__PURE__ */ jsx(Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", children: "Permanently remove expired recordings and temporary call documents older than the retention policy." }) })
        ] }),
        /* @__PURE__ */ jsx(
          Button,
          {
