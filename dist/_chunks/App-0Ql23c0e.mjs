...
const OperationalBadges = ({ pendingApprovals = 0, pendingVerifications = 0 }) => {
  ...
  return /* @__PURE__ */ jsxs(BadgeRow, { children: [
    /* @__PURE__ */ jsx(Typography, { variant: "sigma", textColor: "neutral500", style: { marginRight: "4px" }, children: "Expert Pending Status:" }),
...
//# sourceMappingURL=App-0Ql23c0e.mjs.map
