...
const index = require("./index-kWSmFGji.js");
...
const OperationalBadges = ({ pendingApprovals = 0, pendingVerifications = 0 }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(BadgeRow, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#3b82f6", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(index.UniqueIcon, { style: { width: "13px", height: "13px", color: "#063a8fff" } }),
...
exports.default = App;
//# sourceMappingURL=App-D7kNFxxF.js.map
