...
const index = require("./index-ht2BrxaJ.js");
...
const OperationalBadges = ({ pendingApprovals = 0, pendingVerifications = 0 }) => {
  const apps = pendingApprovals || 12;
  const verifs = pendingVerifications || 8;
  return /* @__PURE__ */ jsxRuntime.jsxs(BadgeRow, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", textColor: "neutral500", style: { marginRight: "4px" }, children: "Live Status:" }),
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#f59e0b", children: [
      /* @__PURE__ */ jsxRuntime.jsx(Nucleus, { color: "#f59e0b" }),
      /* @__PURE__ */ jsxRuntime.jsx(index.Expert, { style: { width: "12px", height: "12px" } }),
      /* @__PURE__ */ jsxRuntime.jsx(Label, { children: "Approvals" }),
      /* @__PURE__ */ jsxRuntime.jsx(Count, { children: apps })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#3b82f6", children: [
      /* @__PURE__ */ jsxRuntime.jsx(Nucleus, { color: "#3b82f6" }),
      /* @__PURE__ */ jsxRuntime.jsx(index.UniqueIcon, { style: { width: "12px", height: "12px" } }),
      /* @__PURE__ */ jsxRuntime.jsx(Label, { children: "Verifications" }),
      /* @__PURE__ */ jsxRuntime.jsx(Count, { children: verifs })
    ] })
  ] });
};
...
exports.default = App;
//# sourceMappingURL=App-I9cz-Ua2.js.map
