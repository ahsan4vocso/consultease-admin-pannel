...
const index = require("./index-it3Vq9nh.js");
...
const OperationalBadges = ({ pendingApprovals = 0, pendingVerifications = 0 }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(BadgeRow, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#f59e0b", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(index.Expert, { style: { width: "13px", height: "13px", color: "#de900aff" } }),
...
exports.default = App;
//# sourceMappingURL=App-BruNSzcl.js.map
