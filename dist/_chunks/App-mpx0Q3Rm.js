...
const index = require("./index-BOXZVbxS.js");
...
const OperationalBadges = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(BadgeRow, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#f59e0b", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(Count, { children: [
        pendingApprovals,
        todayApprovals > 0 && /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { fontSize: "10px", marginLeft: "4px", opacity: 0.8 }, children: [
          "(+",
          todayApprovals,
          " Today)"
        ] })
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#3b82f6", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(Count, { children: [
        ...
        todayVerifications > 0 && /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { fontSize: "10px", marginLeft: "4px", opacity: 0.8 }, children: [
          "(+",
          todayVerifications,
          " Today)"
        ] })
...
exports.default = App;
//# sourceMappingURL=App-mpx0Q3Rm.js.map
