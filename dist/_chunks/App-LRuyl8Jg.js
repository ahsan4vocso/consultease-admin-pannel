...
const index = require("./index-ByfBJVAY.js");
...
const OperationalBadges = ({ pendingApprovals = 0, pendingVerifications = 0 }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(BadgeRow, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#f59e0b", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(index.Expert, { style: { width: "13px", height: "13px", color: "#3e3d3dff" } }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#3b82f6", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(index.UniqueIcon, { style: { width: "13px", height: "13px", color: "#3c3c3dff" } }),
...
exports.default = App;
//# sourceMappingURL=App-LRuyl8Jg.js.map
