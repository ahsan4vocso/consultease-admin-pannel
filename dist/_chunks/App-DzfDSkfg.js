...
const index = require("./index-aa3c74TW.js");
...
const useAdminSummary = (filter = "lifetime") => {
  const { get } = admin.useFetchClient();
  return reactQuery.useQuery({
    queryKey: ["admin-stats-summary", filter],
    queryFn: async () => {
...
const StatsHeader = ({ total = 0, online = 0, filter, onFilterChange }) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(Header$4, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(HeaderRight$1, { children: /* @__PURE__ */ jsxRuntime.jsx(FilterContainer, { children: ["today", "day wise", "monthly", "quarterly", "yearly"].map((period) => /* @__PURE__ */ jsxRuntime.jsx(
      FilterButton,
      {
        active: filter === period,
        onClick: () => onFilterChange(period),
        children: period === "day wise" ? "Day Wise" : period === "today" ? "Today" : period.charAt(0).toUpperCase() + period.slice(1)
      },
      period
    )) }) })
  ] });
...
const StatsDashboardPage = () => {
  ...
  const { data: summary, isLoading: isSummaryLoading } = useAdminSummary(filter);
...
exports.default = App;
//# sourceMappingURL=App-DzfDSkfg.js.map
