...
const PluginIcon = ({ style }) => /* @__PURE__ */ jsxRuntime.jsxs("svg", { style: { width: "24px", height: "24px", ...style }, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-ZI8fV7Sp.js"));
        return App;
      }
    });
    app.registerPlugin({
