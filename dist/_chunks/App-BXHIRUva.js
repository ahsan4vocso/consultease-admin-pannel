...
const index = require("./index-SnZccuGQ.js");
...
const OperationalBadges = ({ pendingApprovals = 0, pendingVerifications = 0 }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(BadgeRow, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#f59e0b", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(index.Expert, { style: { width: "13px", height: "13px", color: "#976104ff" } }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(MiniBadge, { color: "#3b82f6", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(index.UniqueIcon, { style: { width: "13px", height: "13px", color: "#0b4db7ff" } }),
...
exports.default = App;
//# sourceMappingURL=App-BXHIRUva.js.map
