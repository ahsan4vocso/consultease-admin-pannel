...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("../_chunks/App-hwJCzjsR.js"));
        return App;
      }
    });
    app.registerPlugin({
